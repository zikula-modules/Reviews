{* purpose of this template: reviews rss feed in user area *}
...
{foreach item='review' from=$items}
    <item>
        ...
        <link>{modurl modname='Reviews' type='user' func='display' ot='review' id=$review.id slug=$review.slug fqurl='1'}</link>
        <guid>{modurl modname='Reviews' type='user' func='display' ot='review' id=$review.id slug=$review.slug fqurl='1'}</guid>
