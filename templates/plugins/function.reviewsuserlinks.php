 ...
 * @version $Id: function.reviewsuserlinks.php 416 2010-06-14 04:52:19Z drak $
...
function smarty_function_reviewsuserlinks($params, &$smarty)
{
    ...
    if (SecurityUtil::checkPermission('Reviews::', "::", ACCESS_OVERVIEW)) {
        $userlinks[] = array('url'  => ModUtil::url('Reviews', 'user'),
                             'text' => __('Reviews index', $dom));
    }
    if (SecurityUtil::checkPermission('Reviews::', "::", ACCESS_OVERVIEW)) {
        $userlinks[] = array('url'  => ModUtil::url('Reviews', 'user', 'view'),
