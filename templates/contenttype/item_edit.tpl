...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='reviewsObjectType' __text='Object type'}
            {reviewsObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='reviewsObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {reviewsItemSelector id='id' group='data' objectType=$objectType}
    </div>
