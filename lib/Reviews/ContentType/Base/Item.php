 ...
 */
class Reviews_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('Reviews detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single Reviews object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('Reviews', 'external', 'display', $this->getDisplayArguments());
        }
