 ...
 */
class Reviews_ContentType_Base_ItemList extends Content_AbstractContentType
{
    /**
    ...
    public function getTitle()
    {
        ...
        return __('Reviews list view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display list of Reviews objects.', $dom);
    }
    ...
    public function display()
    {
        ...
        $this->view->toplevelmodule = 'Reviews';
    
        $this->view->setCaching(Zikula_View::CACHE_ENABLED);
        // set cache id
        $component = 'Reviews:' . ucwords($this->objectType) . ':';
        $instance = '::';
        ...
        if (in_array($this->objectType, $this->categorisableObjectTypes)) {
            if (is_array($this->catIds) && count($this->catIds) > 0) {
                $qb = ModUtil::apiFunc('Reviews', 'category', 'buildFilterClauses', array('qb' => $qb, 'ot' => $this->objectType, 'catids' => $this->catIds));
            }
        }
    ...
    {
        return array('objectType' => 'review',
                     'sorting' => 'default',
                     'amount' => 1,
    ...
    public function startEditing()
    {
        ...
        array_push($this->view->plugins_dir, 'modules/Reviews/templates/plugins');
