 ...
 */
class Reviews_Listener_ModuleDispatch extends Reviews_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('Reviews', 'user', 'main'), 'text' => __('Link Text'));
    }
}
