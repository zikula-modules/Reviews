 ...
 */
class Reviews_Form_Plugin_Base_ItemSelector extends Zikula_Form_Plugin_TextInput
{
    /**
    ...
    {
        parent::decode($view);
        $this->objectType = FormUtil::getPassedValue('Reviews_objecttype', 'review', 'POST');
        $this->selectedItemId = $this->text;
    }
}
