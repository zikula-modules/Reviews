...
/**
 * This handler class handles the page events of the Form called by the reviews_user_edit() function.
 * It aims on the review object type.
 *
 * More documentation is provided in the parent class.
 */
class Reviews_Form_Handler_User_Review_Base_Edit extends Reviews_Form_Handler_User_Edit
{
    /**
     * Pre-initialise hook.
     *
