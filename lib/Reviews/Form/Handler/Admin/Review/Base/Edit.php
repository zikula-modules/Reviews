 ...
 */
class Reviews_Form_Handler_Admin_Review_Base_Edit extends Reviews_Form_Handler_Admin_Edit
{
    /**
     * Pre-initialise hook.
     *
    ...
    public function preInitialize()
    {
        ...
        $this->objectType = 'review';
        $this->objectTypeCapital = 'Review';
        $this->objectTypeLower = 'review';
    
        $this->hasPageLockSupport = true;
        $this->hasCategories = true;
        $this->hasSlugUpdatableField = false;
        // array with upload fields and mandatory flags
        $this->uploadFields = array('coverUpload' => false);
        // array with list fields and multiple flags
        $this->listFields = array('workflowState' => false, 'score' => false);
    }
    ...
    protected function getDefaultMessage($args, $success = false)
    {
        ...
        switch ($args['commandName']) {
            case 'submit':
                        if ($this->mode == 'create') {
                            $message = $this->__('Done! Review created.');
                        } else {
                            $message = $this->__('Done! Review updated.');
                        }
                        break;
            case 'delete':
                        $message = $this->__('Done! Review deleted.');
                        break;
            default:
                        $message = $this->__('Done! Review updated.');
                        break;
